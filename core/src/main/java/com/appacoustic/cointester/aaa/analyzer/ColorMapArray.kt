 ...
 */
internal object ColorMapArray {
    @JvmStatic
    fun selectColorMap(colorMapName: String): IntArray {
        return when (colorMapName.toLowerCase()) {
            "hot" -> hot
            "jet" -> jet
            "gray" -> gray
            "blackbody_uniform" -> blackbody_uniform
            "parula" -> parula
            "magma" -> magma
            "inferno" -> inferno
            "plasma" -> plasma
            "viridis" -> viridis
                ...
                i("No this color map: $colorMapName")
                hot
            }
        }
    }
    ...
    val blackbody_uniform = intArrayOf(
        0xd2e2ff,
        0xd4e1ff,
        0xd5e1ff,
        0xd6e0ff,
